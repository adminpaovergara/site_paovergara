  ...
  return (
    <main className="py-20">
      <SectionIntro
        ...
        copy={
          locale === "es"
            ? "Comparte el tipo de pieza, tiempos, ciudad y referencias visuales. Responderemos con el siguiente paso."
            : "Share the type of piece, timing, city and visual references. We will reply with the next step."
        }
      />
